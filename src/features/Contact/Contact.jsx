    ...
    <div>
        ...
        <div className="flex sm:flex-col xl:flex-row xl:gap-[5rem] ">
          <div className="flex sm:flex-col gap-2 lg:gap-[2rem] xl:pt-[50px]">
            <div className="flex items-center gap-2 ">
              <h1 className="sm:text-[17px] font-[700] lg:text-xl">
                Contact Us
              </h1>
            ...
            <div className="sm:w-[290px] lg:w-[360px] xl:w-[470px]">
              <h1 className="sm:text-2xl font-[700] lg:text-3xl  xl:text-[40px]">
                We’d Love To <span className="text-[#8AA823]">Hear Back</span>{" "}
                From You
              </h1>
            </div>
            <div className="sm:w-[420px] xl:w-[475px]">
              <p className="text-[#475156] sm:text-[16px] xl:text-[18px]">
            ...
            <div className="mt-4 flex sm:gap-5 sm:justify-center xl:justify-start">
              <div className="border-2 flex justify-between rounded-[8px]  flex-col items-center py-3 sm:w-[250px] sm:h-[150px]">
                ...
                <p className="sm:text-[15px] text-[#023B3B] font-[600]">
          ...
          <div className="flex sm:justify-center sm:h-[700px] sm:mt-10">
            <div className="sm:w-[400px] sm:h-[400px] flex flex-col  gap-[24.65px] lg:w-[505px] lg:h-[676px] ">
              <h1 className="sm:text-2xl font-[700] sm:text-center lg:text-3xl xl:text-start">
                Get in touch
              </h1>
              <p className="text-[#131313] sm:text-[16px] font-[400] sm:text-center xl:text-start">
                We’d love to hear from you. Please fill out this form
              </p>

              <div className="flex gap-2 items-center">
                <div className="flex flex-col sm:w-[50%]">
                  <label className="sm:text-[16px] font-[400]">
                    First Name
                  </label>
                  <input
                    type="text"
                    placeholder="First Name"
                    className=" sm:h-[45px] border rounded-md border-[#9C9C9C] outline-none px-3"
                  />
                </div>
                <div className="flex flex-col sm:w-[50%]">
              ...
              <div className="flex  flex-col w-full  ">
                ...
                <div className="flex items-center border-[#9C9C9C] border rounded-md pr-[5px]  ">
                  <select
                    className="pl-[0.75rem]  font-[400] text-[#B9B9B9] rounded-md  bg-transparent"
                    id="category"
                    name="category"
                  >
                  ...
                  <input
                    ...
                    className=" sm:h-[45px]  outline-none px-3"
                  />
                </div>
              </div>
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  className=" py-2 resize-none sm:h-[100px] border rounded-md border-[#9C9C9C] outline-none px-3"
                />
              </div>
      ...
      <div className="mt-5 relative sm:w-[100%] sm:h-[440px] 2xl:h-[450px]">
        ...
        <div className="absolute z-[200] flex flex-col top-10 sm:left-[50px] md:left-[60px]  lg:left-[80px]">
          <h1 className="sm:text-[30px] font-[700] text-[#8AA823] mb-5 2xl:text-[2.5rem]">
            Global Presence
          </h1>
