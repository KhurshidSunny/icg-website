        ...
        <div className="pt-8 leading-loose">
          <div className="pt-8 pb-6">
            ...
            <p className="pt-6 dark:text-gray-300">
              ...
              polymer industries to impart color, enhance properties, and
              optimize processing. ICG Specialty Chemicals offers a wide range
              of masterbatches tailored for specific industrial applications,
          ...
          <div>
            ...
            <p className=" dark:text-gray-300">
              Liquid/Paste Black Masterbatch is a concentrated colorant
              formulated for easy dispersion into a variety of plastic resins.
              This product offers superior color consistency and is ideal for
              applications that require deep, rich black tones with minimal
              usage levels. Its paste form makes it convenient to mix directly
              into liquid or semi-liquid processing environments.
            </p>
            <h3 className="text-xl font-semibold px-4 p-2 dark:text-white">
              Key Benefits:
            </h3>
            <ul className="list-[circle] list-inside space-y-4 p-4 dark:text-gray-300">
              ...
              <li>
                Suitable for injection molding, extrusion, and film
                applications.
              </li>
          ...
          <div>
            ...
            <p className=" dark:text-gray-300">
              Black Masterbatch is a versatile, solid concentrate of carbon
              black pigments designed for efficient and uniform coloring of
              plastic materials. It provides excellent opacity, UV stability,
              and mechanical performance enhancement. Black masterbatch by ICG
              Specialty Chemicals is specifically formulated to meet the
              stringent demands of sectors that require robust coloration with
          ...
          <div>
            ...
            <p className=" dark:text-gray-300">
              ...
              moisture-related defects like voids, bubbles, and surface
              blemishes in plastic parts. This masterbatch is essential for
              improving the processing efficiency of hygroscopic materials,
              reducing downtime, and ensuring consistent output.
            </p>
            <h3 className="text-xl font-semibold px-4 p-2 dark:text-white">
              Key Benefits:
            </h3>
            <ul className="list-[circle] list-inside space-y-4 p-4 dark:text-gray-300">
              ...
              <li>
                Improves the quality of finished products by preventing splay
                and streaking.
              </li>
