  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      const data = await axiosInstance.get(
        `/products/?page=${page}&limit=${limit}&categoryName=Antioxidants`,
        {
          headers: {
      ...
      <div className="container mx-auto px-6 lg:px-16 py-10">
        ...
        <div className="pt-8 leading-loose">
          <div className="pt-8 pb-6">
            ...
            <p className="pt-6 dark:text-gray-300">
              ...
              properties, and eventually, complete material failure.
              Antioxidants are crucial additives used to protect polymers from
              degradation due to oxidative processes.
              <br />
              ...
              Antioxidants work by neutralizing the harmful effects of
              oxidation. The oxidative degradation process involves the
              formation of free radicals—highly reactive molecules that
              propagate chain reactions, breaking down polymer chains.
              <br />
          ...
          <div className="">
            ...
            <p className="dark:text-gray-300">
              are designed to neutralize free radicals and interrupt the
              oxidation process. These are the first line of defense and are
              effective during the early stages of oxidation. Primary
              antioxidants usually consist of hindered phenols, aromatic amines,
              and metal deactivators. Common examples of primary antioxidants
              include:
            </p>
            ...
            <ul className="mx-auto p-6 list-disc list-inside space-y-4 dark:text-gray-300">
              <li>
                ...
                (0.01-0.1%). Commonly used in plastics, elastomers, coatings,
                and adhesives, these antioxidants ensure long-term stability
                with low volatility and non-staining properties.
              </li>
              <li>
              ...
              <li>
                ...
                deactivators are characterized by their low melting point and
                ease of use, providing good stability and strong anti-aging
                properties. They effectively deactivate metal ion activity,
                preventing the acceleration of polyolefin degradation, making
                them ideal for applications in PP/PE wire and cable, as well as
            ...
            <ul className="mx-auto p-6 list-disc list-inside space-y-4 dark:text-gray-300">
              <li>
                <span className="font-bold">Phosphites/Phosphonites:</span>{" "}
                These compounds react with hydroperoxides, converting them into
                stable alcohols and thus inhibiting further degradation.
                Phosphites are often used in PVC and polycarbonate (PC) to
                enhance heat stability.
              </li>
              <li>
                <span className="font-bold">Thioesters:</span> These
                sulfur-based compounds are particularly effective in systems
                requiring high-temperature stabilization. They decompose
                hydroperoxides by converting them into non-reactive species,
                protecting the polymer from oxidative breakdown.
              </li>
              <li>
                <span className="font-bold">Thiosynergists:</span> Provide
                superior long-term heat resistance compared to DSTDP/DLTDP and
                are odorless. They are ideal for long-term stabilization in
                PP/PE, including filler-modified PP/PE, wire, and cable
                applications.
              </li>
              <li>
                <span className="font-bold">Antioxidant Blends:</span> These
                offer excellent processing, color, and heat stability with no
                residual impurities, available in dust-free granule form.
                Typically available in granule form, they are easy to handle and
                reduce dust, making them safer and cleaner to work with in
                industrial environments. They are used in polyolefins, PC and PC
                alloys, nylon, styrenics, elastomers, and POM for enhanced
                durability.
              </li>
            </ul>
        ...
        <div className="px-20 pb-10">
          <div className="flex justify-between pt-10 pb-10">
            ...
            <a
              href={`all-products/Antioxidants`}
