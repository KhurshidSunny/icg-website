  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      const data = await axiosInstance.get(
        `/products/?page=${page}&limit=${limit}&categoryName=Polymers and resins`,
        {
          headers: {
      ...
      <div className="container mx-auto px-6 lg:px-16 py-10">
        ...
        <div className="pt-8 leading-loose">
          ...
          <p className=" dark:text-gray-300">
            ...
            applications. These compounds possess unique chemical properties
            that enable them to be used in various high-performance products,
            contributing to sectors such as automotive, construction,
          ...
          <div className="py-6">
            ...
            <ul className="list-inside  dark:text-gray-300">
              ...
              <li>
                Nylon 6 is a widely used engineering polymer characterized by
                its high tensile strength, excellent abrasion resistance, and
              ...
              <div className=" dark:text-gray-300">
                ...
                used in applications requiring flexibility, impact resistance,
                and adhesion. EVA grades vary depending on the vinyl acetate
                (VA) content, affecting the material's properties.
                <ul className="list-disc list-inside space-y-4 pb-2 dark:text-gray-300">
                  <li>
                    <span className="font-bold">EVA 18% VA Content:</span>{" "}
                    Offers moderate flexibility and impact resistance, often
                    used in packaging films and adhesives.
                  </li>
                  <li>
                    <span className="font-bold">EVA 24% VA Content:</span>{" "}
                    Provides enhanced elasticity, making it suitable for
              ...
              <div className="dark:text-gray-300">
                ...
                industry. It improves the processability of plastics and
                enhances the appearance and stability of finished products.
              </div>
              <p className="font-bold dark:text-gray-300">
          ...
          <div className="pb-6">
            ...
            <ul className="list-inside dark:text-gray-300">
              ...
              <li>
                ...
                known for its excellent adhesive properties, mechanical
                strength, and chemical resistance. It is essential in industries
                like electronics, aerospace, and construction.
              </li>
        ...
        <div className="px-20 pb-10">
          <div className="flex justify-between pt-10 pb-10">
            ...
            <a
              href={`all-products/Polymers and resins`}
