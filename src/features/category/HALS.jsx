        ...
        <div>
            ...
            >
                ...
                <div className="absolute inset-0 flex justify-center items-center">
                    <h3 className="text-4xl text-white"> HINDERED
                        AMINE LIGHT
                        STABILIZERS
                        (HALS)</h3>
                </div>
            ...
            <div className="pt-8 px-20 leading-loose">
                <div className="pt-8 pb-6">
                    <p className="pt-6">
                        ...
                        are compounds that protect polymers
                        from UV radiation by scavenging free
                        radicals generated during photooxidation,
                        thereby preventing polymer degradation.
                        HALS are crucial in inks, coatings, and
                        adhesives for providing UV stability,
                        enhancing durability, and ensuring the
                        longevity of these materials in various
                        applications.
                    </p>
                </div>
                <div className="">
                    <h3 className="text-2xl font-semibold pb-4 text-[#023B3B]">Hindered Amine Light Stabilizers (HALS)</h3>
                    <p className="">
                        Although not technically UV absorbers, HALS play a complementary role by scavenging free radicals formed during UV exposure, thus preventing further degradation of materials.
                    </p>
                </div>
            </div>
