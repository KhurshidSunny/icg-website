...
export default function AllProductsByCategory() {
  ...
  return (
    <div className="px-6 py-8 container mx-auto min-h-screen">
      <h2 className="text-2xl font-semibold text-green-700 mb-6">Products</h2>
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        {data?.products.map((product) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-2">CAS: {product.cas_no}</p>
          </Link>
        ))}
      </div>
