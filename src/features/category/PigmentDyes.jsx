  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      const data = await axiosInstance.get(
        `/products/?page=${page}&limit=${limit}&categoryName=Pigments and Dyes`,
        {
          headers: {
  ...
  return (
    <div className="min-h-screen dark:bg-background-dark">
      <div className="container mx-auto px-6 lg:px-16 py-10">
        ...
        <p className="pb-4 dark:text-gray-300">
          <span className="font-bold">Pigments</span> are finely ground,
          insoluble substances that provide color to materials by scattering
          light. They do not dissolve in the medium and are typically used in
          coatings, paints, plastics, inks, and construction materials. Pigments
          are prized for their stability, opacity, and durability.
        </p>
        <p className="pb-4 dark:text-gray-300">
          ...
          dyeing. When applied, dyes penetrate the substrate, creating a
          chemical bond that offers vivid and often longer-lasting color. Dyes
          are primarily utilized in textiles, paper, and certain types of
          plastics.
        </p>
        ...
        <ul className="list-decimal list-inside space-y-4 pb-4 dark:text-gray-300">
          <li>
            <span className="font-bold">Solubility</span> Pigments are
            insoluble; dyes are soluble.
          </li>
          <li>
        ...
        <div className="px-20 pb-10">
          <div className="flex justify-between pt-10 pb-10">
            ...
            <a
              href={`all-products/Pigments and Dyes`}
