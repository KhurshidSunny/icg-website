  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      const data = await axiosInstance.get(
        `/products/?page=${page}&limit=${limit}&categoryName=Flame Retardants`,
        {
          headers: {
    ...
    <div className="min-h-screen dark:bg-background-dark">
      <div className="container mx-auto px-6 lg:px-16 py-10">
        ...
        <p className="font-normal text-[#000000] mb-6 dark:text-gray-300">
          ...
          material needs. Flame retardants can be categorized into several types
          based on their chemical composition and mechanism of action:
        </p>
        ...
        <ul className="list-inside dark:text-gray-300">
          <li className="p-2">
            ...
            ethane flame retardant, ideal for high-temperature thermoplastics
        ...
        <ul className="list-inside dark:text-gray-300">
          ...
          <li className="p-2">
            <span className="font-bold">OMNIQUAN BDDP:</span> BDDP is an
        ...
        <p className="p-2  dark:text-gray-300">
          Promote char formation to inhibit flammable gas release, widely used
          in polymers and coatings.
        </p>
        <ul className="list-inside  dark:text-gray-300">
          <li className="p-2">
            <span className="font-bold">OMNIQUAN FR TBEP:</span> Phosphate flame
            retardant, commonly used in flexible polyurethane foams and
            coatings.
          </li>
          <li className="p-2">
            <span className="font-bold">OMNIQUAN FR TCPP:</span> Phosphate flame
            retardant for use in flexible and rigid polyurethane foams, as well
            as thermoplastics.
          </li>
        </ul>
        <h3 className="text-xl font-semibold py-4 text-[#023B3B] dark:text-white">
        ...
        <ul className="list-inside dark:text-gray-300">
          <li className="p-2">
            <span className="font-bold">ALUMINIUM HYDROXIDE (ATH):</span> A
            widely used inorganic flame retardant for construction, electronics,
        ...
        <ul className="pl-4 list-decimal list-inside space-y-4 dark:text-gray-300">
          ...
          <li className="py-2">
            <span className="font-bold">Versatility:</span> Suitable for a
        ...
        <ul className="pl-4 list-decimal list-inside space-y-4 dark:text-gray-300">
          ...
          <li className="py-2">
            <span className="font-bold">Textiles: </span>Upholstery, curtains,
            and fire-resistant clothing.
          </li>
          <li className="py-2">
            <span className="font-bold">Automotive: </span>Interior materials
            and wiring.
          </li>
          <li className="py-2">
            <span className="font-bold">Furniture: </span>Foams and wood
            products that meet fire safety standards.
          </li>
        </ul>
        ...
        <div className="px-20 pb-10">
          <div className="flex justify-between pt-10 pb-10">
            ...
            <a
              href={`all-products/Flame Retardants`}
            ...
            {data?.products?.map((product, index) => (
              <a href={`/available-stocks/${product._id}`} key={product._id}>
                <div className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm text-center dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <p className="text-gray-600 dark:text-gra-300">
                    {product.cas_no}
                  </p>
                </div>
              </a>
