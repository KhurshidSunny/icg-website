      ...
      <div className="container mx-auto px-6 lg:px-16 py-10">
        ...
        >
          ...
          <div className="w-2/3 space-y-6 text-justify" style={{ width: "59%" }}>
            <h2
              className="text-2xl lg:text-3xl font-bold text-teal-900 dark:text-white"
              style={{ width: "812px" }}
            >
              <span className="text-[#8AA823]">CEO</span> Message
            </h2>
            <p className="text-gray-700 text-base leading-7 text-justify dark:text-gray-300">
            ...
            <p className="text-gray-700 text-base leading-7 dark:text-gray-300">
