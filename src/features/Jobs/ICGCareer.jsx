  ...
  return (
    <div className="container mx-auto px-6 lg:px-16 py-10">
      ...
      <div>
        ...
        <p className="mt-3 font-[400] 2xl:text-xl">
      ...
      <div className="mt-10 flex flex-col gap-2 justify-center items-center">
        <h1 className="sm:text-2xl font-[700]">
          Want to join Team{" "}
          <span className="text-[#8AA823]">ICG Chemicals?</span>
        </h1>
        <p className="sm:text-[16px] sm:w-[430px sm:text-center 2xl:text-xl">
      ...
      <div>
        {data?.jobs?.map((job) => (
          <div
            key={job._id}
            className="w-full sm:h-[200px] py-4 px-8 rounded-[8px] mt-10 bg-[#FAFAFA]"
          >
            <div className="flex justify-between ">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <h1 className="sm:text-2xl 2xl:text-3xl ">{job.title}</h1>
                  <p className="sm:text-[16px] sm:w-[330px] 2xl:text-xl 2xl:w-[560px]">
                    {job.description}
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  {/* <button className="px-4 py-2 sm:text-[18px] flex items-center gap-2 border-[#8AA823] border  rounded-[6.65px]">
                    Hybrid{" "}
                    <GoArrowRight className="sm:text-2xl text-[#8AA823]" />
                  </button> */}
                  <button className="px-6 py-2 sm:text-[18px] border-[#8AA823] border rounded-[6.65px] ">
                    {job.employment_type}
                  </button>
                </div>
              </div>
              <div className="flex items-center">
                <a
                  href={`/job/${job._id}`}
                  className="px-6 py-2 sm:text-[18px] bg-[#8AA823] text-white rounded-[6.5px]"
                >
                  View
                </a>
              </div>
        ...
        {data?.jobs?.length === 0 && (
          <div className="w-full sm:h-[200px] py-4 px-8 rounded-[8px] mt-10 bg-[#FAFAFA] flex items-center justify-center">
            <h1 className="sm:text-2xl 2xl:text-3xl">No Jobs Found</h1>
          </div>
        )}
